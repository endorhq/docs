...
<StepList title="Configure Endor in VSCode">
  <StepItem step={1}>Ensure you have the [MCP extension installed and agent mode enabled](https://code.visualstudio.com/docs/copilot/chat/mcp-servers#_enable-mcp-support-in-vs-code)</StepItem>
  <StepItem step={2}>
  ...
  <StepItem step={4}>Try Endor using Copilot in "Agent Mode"</StepItem>
</StepList>
