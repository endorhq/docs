...
A Pod is the name of the development sandboxes that you can create with Endor. The name is inspired by “coffee pods” and “escape pods”, and we aim to make them easy to use and self-contained. Think of it as a “virtual machine that runs inside your browser”
...
## How can I save changes I make to the Pod?

Currently it is not possible. All changes inside the Pod are lost if you close or reload the browser tab. We plan to add persistence support in the near future, but for now Pods are best thought of as temporary development sandboxes.
...
- Are slow: Applications generally run an order of magnitude slower.
...
We are working on addressing them to make Endor even more useful.
