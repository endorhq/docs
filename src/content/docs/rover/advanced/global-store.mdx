---
title: Global Store
description: Understand where Rover stores the task metadata, logs, and results.
sidebar:
    order: 1
---
...
Rover maintains a global store for configuration, task metadata, workspaces, and logs. Each [project](/rover/concepts/project) has it's own separate folder. This guide explains the directory structure, files, and how to troubleshoot common issues.
...
This ensures unique IDs even for projects with the same name in different locations.
