...
<CardGrid>
  <LinkCard title="Common Workflows" href="/rover/common-workflows" description="Read more about common workflows with Rover and how they make you more productive. From initialization all the way down to debugging." />
  <LinkCard title="VSCode Extension" icon="document" href="/rover/vscode-extension" description="Integrate Endor with VSCode to never leave your favorite IDE in order to get agentic help." />
  <LinkCard title="Command Reference" icon="document" href="/rover/command-reference" description="Exhaustive Rover command reference." />
  <LinkCard title="Overview" icon="forward-slash" href="/rover/overview" description="Rover Overview." />
</CardGrid>