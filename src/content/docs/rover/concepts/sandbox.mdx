...
|----------------|---------|---------------|
| **npm** | Node.js packages | `npm install lodash` |
| **apk** | Alpine Linux system packages | `apk add curl` |
| **uv** | Python package management | `uv pip install requests` |
| **Nix** | Cross-platform package manager | `nix-env -i git` |
