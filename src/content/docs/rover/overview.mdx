...
Rover has very basic telemetry reporting to help us understand how our users prefer to use the tool. This telemetry does not identify or record user data. The only information that is recorded by the telemetry is which action was invoked, and in some cases, very basic information about that action.
