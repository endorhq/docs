...
<CardGrid>
  ...
  <LinkCard title="Project Configuration" href="/rover/config/project-config" description="Configure other project-wide settings" />
  <LinkCard title="Hooks" href="/rover/config/hooks" description="Run commands at task lifecycle events" />
</CardGrid>
