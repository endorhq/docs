...
<Aside type="caution">
You might face difficulties if you try to mount a host directory with a huge number of files. If you notice that you don't see the mounted volume in the sandbox, try again with a volume with a smaller number of files. This limitation will be lifted as soon as possible.
</Aside>
