...
See the [Setup guide](/cli/setup) for detailed installation instructions.
...
Check our [MCP integration guides](/cli/mcp/overview) for step-by-step setup with Claude Code, Cursor, and other AI tools.
