...
You can allow public network access passing the `--allow-net` flag. See [Networking](../networking).
...
<StepList title="Using Alpine Container">
  <StepItem step={1}>
    Start the Alpine service with public network access (See [Networking](../networking/)):
