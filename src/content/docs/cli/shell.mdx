...
<StepList title="Access Service Shell">
  <StepItem step={1}>
    ...
    For network access, add the `--allow-net` flag ([see Networking](/cli/networking)):
...
Learn more about [MCP integration](/cli/mcp/overview) and how AI agents can manage your Endor services.
