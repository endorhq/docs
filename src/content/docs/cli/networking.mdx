...
- [Goose CLI](/cli/mcp/goose)
- [VSCode](/cli/mcp/vscode)
- [Cursor](/cli/mcp/cursor)
- [Windsurf](/cli/mcp/windsurf)

Learn more about [MCP integration](/cli/mcp/overview) and how AI agents can manage your development environments.
